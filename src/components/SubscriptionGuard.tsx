...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'laporan-rekap-konsumen'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'laporan-rekap-konsumen') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'laporan-rekap-konsumen'): boolean => {
    try {
